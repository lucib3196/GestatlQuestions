import pytest
from api.models.question_model import Question, Topic
from api.data import question_db as question_service
from api.data import topic_db as topic_service
from api.data import qtype_db as qtype_service
from api.data import language_db as l_service
from backend.src.app_test.unit.database.conftest import  db_session
from api.utils import normalize_names
